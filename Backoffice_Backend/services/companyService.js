// Archivo: services/companyService.js
...
const list = async () => Company.find({}).sort({ createdAt: -1 });
...
const updateById = async (id, payload) => {
  ...
  return Company.findByIdAndUpdate(id, payload, { new: true, runValidators: true });
};
